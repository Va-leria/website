...
const stages = [

  {
    ...
    letters: {
    L: "M 1.55 163 L 100.95 163 L 100.95 124.10 L 38.60 124.10 L 40.60 2.00 L 1.55 2.00 L 1.55 163 L 1.55 163 Z",
    I: "M 40 0 L 40 163 L 80 163 L 80 0 L 40 0 Z",
    F: "M 0 0 L 0 163 L 45 163 L 45 125 L 45 125 L 45 100 L 120 100 L 120 62 L 45 62 L 45 38 L 132 38 L 132 0 L 0 0 Z",
...

  {
    ...
    typefaceUrl: "https://www.typography.com/fonts/gotham/styles",
    letters: {
    H: "M 0 0 L 0 163 L 40 163 L 40 100 L 100 100 L 100 163 L 140 163 L 140 0 L 100 0 L 100 63 L 40 63 L 40 0 L 0 0 Z",
    E: "M 1.55 163 L 132.19 163 L 132.19 125.05 L 45.71 125.05 L 45.71 99.52 L 122.99 99.52 L 122.99 64.33 L 45.71 64.33 L 45.71 39.95 L 131.04 39.95 L 131.04 2.00 L 1.55 2.00 L 1.55 163 L 1.55 163 Z",
    L: "M 1.55 163 L 100.95 163 L 100.95 124.10 L 40.60 124.10 L 40.60 2.00 L 1.55 2.00 L 1.55 163 L 1.55 163 Z",
    O: "M 60 2 Q 35 2 20 17 Q 5 32 5 57 L 5 107 Q 5 132 20 147 Q 35 162 60 162 Q 85 162 100 147 Q 115 132 115 107 L 115 57 Q 115 32 100 17 Q 85 2 60 2 Z M 60 22 Q 73 22 81.5 30.5 Q 90 39 90 52 L 90 112 Q 90 125 81.5 133.5 Q 73 142 60 142 Q 47 142 38.5 133.5 Q 30 125 30 112 L 30 52 Q 30 39 38.5 30.5 Q 47 22 60 22 Z"
  },
  start: [0, 150, 300, 450, 550],
  solution: [0, 11, 14, -15, 0],
  lines: [1, 163]
  },
  ...
  start: [0, 150, 280, 400, 500, 650],
  solution: [0, 2, 18, 15, 30, 0],
  lines: [1, 163]
  },
...
function Game(){
  ...
  function reload_word(){
    var currentIndex = state.get("stageIndex");
    state.set("stageIndex", currentIndex);
    game.load();
    window.location.reload();
    // state.resetKGData();
    load();
